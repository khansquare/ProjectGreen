...
public class FragmentQuestionTest extends Fragment {
    private boolean mSearchCheck;
    private FloatingActionButton button_next;

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.student_question_area, container, false);
        rootView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
        button_next=(FloatingActionButton)rootView.findViewById(R.id.button_next);
